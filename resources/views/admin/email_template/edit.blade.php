                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="@lang('Email subject')"
                                    name="subject" value="{{ $email_template->subj }}" />
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="email_body" rows="10" class="form-control" placeholder="@lang('Your message using shortcodes')">{{ $email_template->email_body }}</textarea>
                            </div>
