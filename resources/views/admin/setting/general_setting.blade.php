                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">@lang('Regular Support')</label>
                                    <code>(@lang('For month max:12'))</code>
                                    <input class="form-control form-control-lg" type="number" name="regular"
                                        value="{{ $general->regular }}">
                                </div>
                            </div>

                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="form-group">
                                    <label class="font-weight-bold">@lang('Extended Support') </label>
                                    <code>(@lang('For month max:12'))</code>

                                    <input class="form-control form-control-lg" type="number" name="extended"
                                        value="{{ $general->extended }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-3 col-md-4 col-sm-6">
                                <label class="font-weight-bold">@lang('Referral System')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                                    data-off="@lang('Disabled')" name="referral_system"
                                    @if ($general->referral_system) checked @endif>
                            </div>

                            <div class="form-group col-lg-3 col-md-4 col-sm-6">
                                <label class="font-weight-bold">@lang('User Registration')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                            ...
                            <div class="form-group col-lg-3 col-sm-6 col-md-4">
                                <label class="font-weight-bold">@lang('Email Notification')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                            ...
                            <div class="form-group col-lg-12 col-md-6 col-sm-4">
                                <label class="font-weight-bold"> @lang('Chatbot Script')</label>
                                <textarea type='text'  name="suggestion_box" class="form-control form-control-lg" placeholder="Like Twak.to script">{{ $general->suggestion_box ?? '' }}</textarea>
                            </div>
                        </div>
