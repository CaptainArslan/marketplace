            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.category*') }}">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.category*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.category.pending') }}">
                                <a href="{{ route('admin.category.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Other categories')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.reviewers.banned') }} ">
                                <a href="{{ route('admin.reviewers.banned') }}" class="nav-link">
                                    ...
                                    @if ($banned_reviewers_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $banned_reviewers_count }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setpricing.plans*') }}">
                    <a href="{{ route('admin.setpricing.plans') }}" class="nav-link ">
                        <i class="menu-icon las la-arrow-circle-up"></i>
                    ...
                    <a href="javascript:void(0)" class="{{ menuActive('admin.product*', 3) }}">
                        ...
                        @if (
                            $pending_product_count > 0 ||
                                $soft_product_count > 0 ||
                                $hard_product_count > 0 ||
                                $update_pending_product_count > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.product.softrejected') }}">
                                <a href="{{ route('admin.product.softrejected') }}" class="nav-link">
                                    ...
                                    @if ($soft_product_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $soft_product_count }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.hardrejected') }}">
                                <a href="{{ route('admin.product.hardrejected') }}" class="nav-link">
                                    ...
                                    @if ($hard_product_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $hard_product_count }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.resubmit*') }}">
                                <a href="{{ route('admin.product.resubmit') }}" class="nav-link">
                                    ...
                                    @if ($resubmit_product_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $resubmit_product_count }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.update.pending') }}">
                                <a href="{{ route('admin.product.update.pending') }}" class="nav-link">
                                    ...
                                    @if ($update_pending_product_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $update_pending_product_count }}</span>
                                    @endif
                                </a>
                            </li>
                        </ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.payment.pending') }} ">
                                <a href="{{ route('admin.payment.pending') }}" class="nav-link">
                                    ...
                                    @if ($pending_payment_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $pending_payment_count }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }} ">
                        <ul>
                            ...
                            <li
                                class="sidebar-menu-item {{ menuActive(['admin.report.commission', 'admin.report.commission.search']) }}">
