                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-md-4  col-sm-3 col-12">
                                <label class="form-control-label font-weight-bold">@lang('Auto Approve Product') </label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       data-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="is_approve"
                                       @if($user->is_approve) checked @endif>
                            </div>
                            <div class="form-group  col-md-4  col-sm-3 col-12">
                                <label class="form-control-label font-weight-bold">@lang('Make Seller') </label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       data-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="seller"
                                       @if($user->seller) checked @endif>
                            </div>
                        </div>
