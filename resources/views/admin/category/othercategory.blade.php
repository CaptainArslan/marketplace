...
@section('panel')
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang('Image')">
                                            <div class="user justify-content-center">
                                                <div class="thumb"><img
                                                        src="{{ getImage(imagePath()['category']['path'] . '/' . $item->image, imagePath()['category']['size']) }}"
                                                        alt="@lang('image')"></div>
                                            </div>
                                        </td>
                                        <td data-label="@lang('Name')">{{ $item->category_name }}</td>
                                        <td data-label="@lang('Product Count')">{{ $item->othercategoryproduct->count() }}</td>
                                    </tr>
                                @empty
                                    <tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="number" class="form-control" name="buyer_fee" placeholder="@lang('Buyer Fee')"
                                    step="any" required>
                                ...
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        ...
                                        <small class="mt-2 text-facebook">@lang('Supported files'): <b>@lang('jpeg, jpg, png')</b>.
                                            @lang('Image Will be resized to'): <b>{{ imagePath()['category']['size'] }}</b>
                                            @lang('px').
            ...
            <div class="modal-content">
                ...
                <form action="" class="edit-route" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>@lang('Category Name')</label>
                            <input type="text"class="form-control name" placeholder="@lang('Enter Name')"
                                name="name" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Buyer Fee')</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="number" class="form-control buyer-fee" name="buyer_fee"
                                    placeholder="@lang('Buyer Fee')" step="any" required>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">{{ $general->cur_text }}</div>
                                </div>
                            </div>
    ...
    @push('breadcrumb-plugins')
        @if (request()->routeIs('admin.category'))
            <form action="{{ route('admin.category.othercategorysearch') }}" method="GET"
                class="form-inline float-sm-right bg--white">
                <div class="input-group has_append">
                    <input type="text" name="search" class="form-control" placeholder="@lang('Category Name')"
                        value="{{ $search ?? '' }}">
