@php
    ...
    $totalSales = \App\Sell::Where('status',1)->sum('product_price');
@endphp
          ...
          <div class="row mb-30 align-items-center">
            ...
            <div class="col-lg-7 col-md-7 ">
              <div class="row justify-content-center gy-4">
                ...
                <div class="col-xl-4 col-sm-6 footer-overview-item text-center">
                  <h3 class="text-white amount-number">{{$general->cur_sym}}{{getAmount($totalSales)}}</h3>
                  <p class="text-white">@lang('Total Sales')</p>
                </div><!-- footer-overview-item end -->
              </div>
            </div>
