                            ...
                            <div class="row">
                                <div class="col-sm-10 d-flex flex-wrap align-items-center">
                                    ...
                                    <h4 class="ms-2">[@lang('Ticket') :#{{ $my_ticket->ticket }}]
                                        {{ $my_ticket->subject }}</h4>
                                </div>
                                <div class="col-sm-2 text-end">
                                    <a href="{{ route('ticket') }}"><button class="btn btn--primary btn-sm"
                                            data-bs-toggle="modal" data-bs-target="#DelModal"><i
                                                class="las la-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($my_ticket->status != 4)
                                <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form--control custom--file-upload" type="file"
                                                    name="attachments[]" accept=".jpg,.jpeg,.png,.pdf" multiple>
                                    ...
                                    <div class="form-group text-end">
                                        <button type="submit" class="btn-lg btn--base w-100 py-2" name="replayTicket"
                                            value="1">@lang('Reply')</button>
                                    </div>
                                </form>
                            @endif
            ...
            <div class="modal-content">
                <form action="{{ route('ticket.reply', $my_ticket->id) }}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-md px-4 btn--base" name="replayTicket"
