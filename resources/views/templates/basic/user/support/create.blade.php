                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-2 text-end">
                                    <a href="{{ route('ticket') }}" class="btn--base btn-sm">@lang('My Support Tickets')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input name="subject" value="{{ old('subject') }}"
                                            placeholder="@lang('Enter ticket subject')..." class="form--control" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-3 text-end mt-2">
                                            <a href="javascript:void(0)" onclick="extraTicketAttachment()"
                                                class="text-center w-100 py-2 bt-sm btn-sm btn--base reply-add">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <button class=" btn btn--danger" type="button"
                                        onclick="formReset()">&nbsp;@lang('Cancel')</button>
                                </div>
                            </form>
                        </div>
                    </div><!-- card end -->
