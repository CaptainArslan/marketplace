        ...
        <div class="account-area-left style--two">
            <div class="account-area-left-inner">
                <div class="text-center mb-5">
                    ...
                    <p class="fs-14px text-white mt-4">@lang('Don\'t have an account?')</p>
                        <a href="{{ route('user.register') }}"
                            class="text--base"><button type="button" class="btn btn-primary">Sign Up</button></a>
                </div>
        ...
        <div class="account-wrapper style--two">
            ...
            <form class="account-form" method="POST" action="{{ route('user.login') }}"
                ...
                <div class="form-group">
                    ...
                    <div class="custom-icon-field">
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" autocomplete="off"
                            placeholder="@lang('Enter Username')" class="form--control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="mt-3 d-flex flex-wrap justify-content-between">
                    <p class="fs-14px text-white"><i class="las la-lock"></i> <a
                            href="{{ route('user.password.request') }}" class="text--base">@lang('Forgot password?')</a></p>
                </div>
            </form>
