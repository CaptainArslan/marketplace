                                ...
                                <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                                    ...
                                                    @if ($product->bumps)
                                                        @foreach ($product->bumps as $bump)
                                                            <div class="row removebumps">
                                                                ...
                                                                <div
                                                                    class="col-lg-2 form-group min_quantity {{ $bump->min_quantity == 0 ? 'd-none' : '' }}">
                                            ...
                                            @if(!is_null($product->shareable_link))
                                            <div class="col-lg-12 form-group">
                                                ...
                                                <input type="url" name="shearablelink" placeholder="@lang('Enter the shareable or download link of your product')"
                                                    class="form--control" value="{{$product->shareable_link}}">
                                            </div>
                                            @endif
