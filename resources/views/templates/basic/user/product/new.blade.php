                            ...
                            <div class="user-profile-area">
                                <form action="{{ route('user.product.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="profile-thumb product-profile-thumb">
                                                    <div class="avatar-preview">
                                                        <div class="profilePicPreview productPicPreview"
                                                            style="background-image: url({{ getImage('/', imagePath()['p_image']['size']) }})">
                                                        </div>
                                                    </div>
                                                    <div class="avatar-edit">
                                                        <input type='file' name="image" class="profilePicUpload_1"
                                                            id="profilePicUpload_1" accept=".png, .jpg, .jpeg" required>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" placeholder="@lang('Enter product name')"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" id="category" class="form--control"
                                                            ...
                                                            @foreach ($categories as $item)
                                                                <option data-subcategory="{{ $item->subcategories }}"
                                                                    data-category_details="{{ $item->categoryDetails }}"
                                                                    data-buyerfee="{{ $item->buyer_fee }}"
                                                                    data-name="{{ $item->name }}"
                                                    ...
                                                    <div class="form-group othercategory d-none">
                                                        ...
                                                        <input type="text" name="othercategory"
                                                            placeholder="@lang('Enter Category name')" class="form--control">
                                                    ...
                                                    <label>@lang('ShortCode') <sup class="text--danger">*</sup></label>
                                                    <input type="text" id="shortcode" name="shortcode" placeholder="@lang('Enter product ShortCode')"
                                                            class="form--control" required>

                                                    <div class="form-group othercategory d-none">
                                                        <label>@lang('Subcategory Name') <sup class="text--danger">*</sup></label>
                                                        <input type="text" name="othersubcategory"
                                                            placeholder="@lang('Enter Subcategory name')" class="form--control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-5 form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="number" class="form--control regular-price"
                                                    name="regular_price" placeholder="@lang('Enter Amount')" step="any"
                                                    required>
                                        ...
                                        <div class="col-lg-2 form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="text" class="form--control buyer-fee"
                                                    value="{{ auth()->user()->levell->product_charge }}" readonly>
                                                <div class="input-group-append">
                                                    <div class="input-group-text h-100">{{ $general->cur_text }}</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-5 form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="number" class="form--control extended-price"
                                                    name="extended_price" placeholder="@lang('Enter Amount')" step="any"
                                                    required>
                                                <div class="input-group-append">
                                                    <div class="input-group-text h-100">{{ $general->cur_text }}</div>
                                                </div>
                                        ...
                                        <div class="col-lg-12 form-group">
                                            <label>@lang('Keywords/Tags') <sup class="text--danger">*</sup></label>
                                            <select name="tag[]" class="form--control select2-auto-tokenize"
                                                multiple="multiple">
                                            </select>
                                        </div>
                                        <div class="col-lg-12 form-group">
                                            <label>@lang('Description') <code>(@lang('HTML or plain text allowed or you can also include the demo videos urls in it'))</code></label>
                                            <textarea name="description" class="form-control nicEdit" rows="15" placeholder="@lang('Enter your message')"></textarea>
                                        </div>
                                        <div class="col-lg-12 form-group">
                                            <label>@lang('Approval Message') <code>(@lang('This is the message for the admin to approve your product for Sale.Max 255 charecters'))</code></label>
                                            ...
                                            <div class="row addcustomfield">
                                                @foreach ($customfields as $field)
                                                    <label class="form-check-label pl-3">
                                                        <input type="checkbox" class="customfield" name="field_name[]"
                                                            placeholder="{{ $field->placeholder }}"
                                                            value="{{ $field->id }}" class="form-check-input p-2">
                                                        {{ $field->name }}
                                                    </label>
                                                @endforeach
                                            </div>
                                        ...
                                        <div class="col-lg-12 form-group">
                                            ...
                                            <input type="url" name="shearablelink" placeholder="@lang('Enter the shareable or download link of your product')"
                                                class="form--control">
                                        </div>
                                                        ...
                                                        <div class="col-xxl-12 col-xl-12">
                                                            <div class="fileUpload btn btn-orange">
                                                                ...
                                                                <input type="file"
                                                                    ...
                                                                    name="screenshot[]" accept=".jpg,.jpeg,.png" required
...
@push('script')
    ...
    <script>
        ...
        $(".productbumps").on('click', function(e) {
            const id = $(".removebumps").length;
            var html = `<div class= "row removebumps">

             <button type="button" class="removeBtn float-right" style="
             text-align:right !important; background-color: transparent !important;
             "><i class="fas fa-trash text-danger"></i></button>
                                        ...
                                        <div class="col-md-3 form-group is_quantity">
                                            <label>@lang('Quantity if any ') <sup class="text--danger">*</sup></label>
                                            <select name="is_quantity[]" id="is_quantity" target-id="${id}" class="form--control">
                                                <option value="0">@lang('No')</option>
                                                <option value="1">@lang('Yes')</option>
                                            </select>
                                        </div>
        ...
        $(document).on('change', '#is_quantity', function(e) {
            ...
            let sel = ".min_quantity_" + id;
            $(sel).toggleClass('d-none', data != 1);
                $(sel + " input").required = data == 1;
                $(sel + " input").val(data == 1 ? 1: 0);
            // if (data == 0) {
        ...
        (function($) {
            ...
            if (otherid === "Funnels") {
                ...
                $("input[name='shearablelink']").required = false;
            }
            if (otherid === "Others") {
