                                    ...
                                    <div class="col-lg-12">
                                                ...
                                                <div class="user-profile-header">
                                                    <div class="profile-thumb product-profile-thumb">
                                                        <div class="avatar-preview">
                                                            <div class="profilePicPreview productPicPreview" style="background-image: url({{ getImage(imagePath()['p_image']['path'] . '/' . $product->image, imagePath()['p_image']['size']) }})">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label>@lang('Other Category') <sup class="text--danger">*</sup></label>
                                                            <input type="text" value="{{ $product->othercategories->category_name }}" class="form--control" disabled>
                                                            <span style="color:red">Note: This will be approved by
                                                                Admin
                                                                Only</span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('Other Subcategory') <sup class="text--danger">*</sup></label>
                                                            <input type="text" class="form--control" value="{{ $product->othercategories->subcategory_name }}" disabled>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg 4 removebumps">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="input-group mb-2 mr-sm-2">
                                                            <input type="text" class="form--control varient_title" name="varient_title[]" value="{{ $bump->name }}" placeholder="@lang('Enter Bump Name')" step="any">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-8 form-group">
                                                        <label>@lang('Price For Bump')</label>
                                                        <div class="input-group mb-2 mr-sm-2">
                                                            <input type="number" class="form--control buyer-fee varient_price" name="varient_price[]" value='{{ $bump->price }}' placeholder="Enter Pump Price">
                                                    ...
                                                    <div class="col-lg-12 form-group min_quantity {{ $bump->min_quantity == 0 ? 'd-none' : '' }}">
                                                        <label>@lang('Min Quantity') <sup class="text--danger">*</sup></label>
                                                        <div class="input-group mb-2 mr-sm-2">
                                                            <input type="number" class="form--control regular-price" name="min_quantity[]" value={{ $bump->min_quantity }} placeholder="@lang('Enter Quantity')" step="any">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <select class="form--control select2-basic" name="c_details[{{ $catname }}][]" required>
                                                ...
                                                <option value="{{ str_replace(' ', '_', $data) }}" @if ($myselect) selected @endif>
                                                    {{ $data }}
                                                </option>
                                                @endforeach
                                                ...
                                                <div class="row uploadDoc">
                                                    <div class="col-xxl-12 col-xl-12">
                                                        <div class="fileUpload btn btn-orange">
                                                            ...
                                                            <input type="file" class="upload up from--control" name="file" value={{ $product->file }} accept=".zip" onchange="fileURL(this);" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12 form-group url d-none">
                                            ...
                                            <input type="url" name="sourcelink" value="{{ $product->file }}" placeholder="@lang('Enter product Source URL')" class="form--control">
                                        </div>
                                        <div class="row customaction d-none">
                                            ...
                                            <div class="row addcustomfield">
                                                ...
                                                <label class="form-check-label pl-3 ">
                                                    <input type="checkbox" class='customfield' name="field_name[]" value="{{ $cf->id }}" class="form-check-input p-2" {{ $checked }}>
                                                    {{ $cf->name }}
                                                </label>
                                                @endforeach
                                                @endforeach
