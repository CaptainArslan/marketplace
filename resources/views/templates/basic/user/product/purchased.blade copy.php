                        ...
                        <table class="table custom--table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Customfield')">
                                        @php
                                        $customid = [];
                                        @endphp
                                        @foreach ($customfields as $field)
                                        @if ($item->product_id == $field->product_id)
                                        @php
                                        $customid[] = $field->customfield_id;
                                        @endphp
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        if ($response->product_id == $item->product_id && $response->buyer_id == auth()->user()->id) {
                                        $cf = 1;
                                        }
                                        }
                                        @endphp
                                        @if (!empty($customid))
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addresponseModal" class="icon-btn bg--primary reviewBtn" data-id="{{ $item->product->id }}"><i class="las la-star-of-david" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('Please Fill the CustomField')"></i></a>
                                        @endif
                                        @elseif($item->status == 2)
