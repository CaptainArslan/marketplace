            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endif
                        <div class="text-end">
                            <a class="btn btn-sm btn--base addnewBtn" data-id="{{ $warning ?? '' }}"
                                href="{{ route('user.product.new') }}">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="@lang('Status')">
                                                ...
                                                @elseif($item->status == 2)
                                                    <span class="badge badge--warning">@lang('Soft Reject')</span> <a
                                                        href="javascript:void(0)" data-bs-toggle="modal"
                                                        data-bs-target="#softMessageModal{{ $loop->index }}"
                                                        data-id="{{ $item->id }}"><span><i
                                                                class="fas fa-info-circle"></i></span></a>
                                                @elseif($item->status == 3)
                                                    <span class="badge badge--danger">@lang('Hard Reject')</span> <a
                                                        href="javascript:void(0)" data-bs-toggle="modal"
                                                        data-bs-target="#hardMessageModal{{ $loop->index }}"
                                                        data-id="{{ $item->id }}"><span><i
                                                                class="fas fa-info-circle"></i></span></a>
                                            ...
                                            <td data-label="@lang('Update Status')">
                                                ...
                                                @elseif($item->status == 1 && $item->update_status == 3)
                                                    <span class="badge badge--danger">@lang('Rejected')</span> <a
                                                        href="javascript:void(0)" data-bs-toggle="modal"
                                                        data-bs-target="#updateMessageModal{{ $loop->index }}"
                                                        data-id="{{ $item->id }}"><span><i
                                                                class="fas fa-info-circle"></i></span></a>
                                                @else
                                                    <b>@lang('N/A')</b>
                                    ...
                                    <td data-label="@lang('Action')">
                                        ...
                                        @if ($item->status == 1 && ($item->update_status == 0 || $item->update_status == 2 || $item->update_status == 3))
                                            <a href="{{ route('user.product.edit', Crypt::encrypt($item->id)) }}"
                                                class="icon-btn bg--primary"><i class="las la-edit" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="@lang('Update')"></i></a>
                                        ...
                                        @if ($item->status == 2)
                                            <a href="{{ route('user.product.resubmit', Crypt::encrypt($item->id)) }}"
                                                class="bg--primary text-white p-1 rounded">@lang('Resubmit')</a>
                                        @endif
                                    </td>

                                    <div id="deleteModal{{ $loop->index }}" class="modal fade" data-bs-backdrop="static"
                                    ...
                                    <div class="modal fade" id="hardMessageModal{{ $loop->index }}"
                                    ...
                                    <div class="modal fade" id="softMessageModal{{ $loop->index }}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                    ...
                                    <div class="modal fade" id="updateMessageModal{{ $loop->index }}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
