                    ...
                    <div class="col-lg-12">
                        <div class="tab-content-area">
                            <div class="user-profile-area">
                                <form action="{{ route('user.product.resubmit.store', Crypt::encrypt($product->id)) }}"
                                        ...
                                        <div class="col-lg-2 form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="text" class="form--control buyer-fee"
                                                    value="{{ getAmount($product->category->buyer_fee) }}" readonly>
                                                ...
                                                @if ($selected)
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select class="form--control select2-multi-select"
                                                            name="c_details[{{ $catname }}][]" multiple="multiple"
                                                            required>
