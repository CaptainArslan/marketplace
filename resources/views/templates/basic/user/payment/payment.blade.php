                                ...
                                <div class="withdraw-card">
                                    ...
                                    <div class="withdraw-card__body">
                                        <ul class="withdraw-info-list text-center">
                                            <li>@lang('Total') : <b>{{ getAmount($totalPrice) }}
                                                    {{ $general->cur_text }}</b></li>
                                            <li>@lang('Charge') :
                                                <b>{{ $data->fixed_charge != 0 ? getAmount($data->fixed_charge) . $general->cur_text : ' ' }}
                                                    @if ($data->percent_charge > 0)
                                        ...
                                        <button type="submit"
                                            class="btn btn-md btn--base w-100 mt-4 btn--capsule">@lang('Pay Now')</button>
                                    </div>
                                </div>
                            </form>
                        </div>
