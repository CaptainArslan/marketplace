                        ...
                        <table id='data-table' class="table table-bordered data-table custom--table">
                            ...
                            <tbody>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('user.emailtemplate.edit', $template->id) }}" class="icon-btn bg--primary"><i class="las la-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('Update')"></i></a>
                                    ...
                                    <a href="javascript:void(0)" class="icon-btn bg--danger activateBtn" data-bs-toggle="modal" data-bs-target="#activateModal" data-info="{{ $emailtemplates }}" data-id="{{ $template->id }}" data-original-title="@lang('Enable')"><i class="la la-eye"></i></a>
                                    @else
                                    <a href="javascript:void(0)" class="icon-btn bg--success deactivateBtn" data-bs-toggle="modal" data-bs-target="#deactivateModal" data-info="{{ $emailtemplates }}" data-id="{{ $template->id }}" data-original-title="@lang('Disable')"><i class="la la-eye"></i></a>
                                    @endif
                                </td> --}}
                                {{-- Delete Model --}}
                                ...
                                <div class="modal-dialog">
                                    <form action="{{ route('user.emailtemplate.delete') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="emailtemplate_id" value="{{ $template->id }}" required>
