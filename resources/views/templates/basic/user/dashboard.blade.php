                                    ...
                                    <div class="d-widget d-flex flex-wrap align-items-center rounded-3">
                                        ...
                                        <div class="input-group">
                                            <input type="url" id="ref"
                                                ...
                                                class="form-control form-control-lg bg-transparent" readonly>
                                            <button type="button" data-copytarget="#ref"
                                                class="input-group-text bg--base text-white copybtn border-0"><i
                                ...
                                <div class="d-widget d-flex flex-wrap align-items-center rounded-3">
                                    ...
                                    <div class="d-widget__icon rounded">
                                        ...
                                        <a href="{{ route('user.transaction') }}"
                                            class="btn btn-sm btn--base py-1 text-center">@lang('View all')</a>
                                    </div>
                                </div><!-- d-widget end -->
                            </div>
                    ...
                    <div class="col-lg-4 ps-lg-4 mt-lg-0 mt-5">
                        <div class="user-sidebar">
                            <div class="user-widget">
                                ...
                                <p>@lang('You Have') <b
                                        class="bg--base text-white px-2 py-1">{{ getAmount($user->balance) }}
