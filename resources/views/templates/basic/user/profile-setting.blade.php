                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="profile-thumb product-profile-thumb">
                                                ...
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview productPicPreview"
                                                        style="background-image: url({{ getImage(imagePath()['profile']['cover']['path'] . '/' . $user->cover_image, imagePath()['profile']['cover']['size']) }})">
                                                    </div>
                                                </div>
                                                <div class="avatar-edit">
                                                    <input type='file' name="cover_image" class="profilePicUpload"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="user-profile-header">
                                            <div class="profile-thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview"
                                                        style="background-image: url({{ getImage(imagePath()['profile']['user']['path'] . '/' . $user->image, imagePath()['profile']['user']['size']) }})">
                                                    </div>
                                                </div>
                                                <div class="avatar-edit">
                                            ...
                                            <label
                                                class="ps-3 {{ auth()->user()->seller == 0 ? 'd-none' : '' }}">@lang('Company Logo')</label>
                                            <div
                                                class="profile-thumb ps-2 {{ auth()->user()->seller == 0 ? 'd-none' : '' }}">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview"
                                                        style="background-image: url({{ getImage(imagePath()['profile']['user']['path'] . '/' . $user->company_logo, imagePath()['profile']['user']['size']) }})"
                                                        alt="company Logo">
                                                    </div>
                                                </div>
                                                <div class="avatar-edit">
                                                    <input type='file' name="logoimage" class="logoPicUpload"
                                                        id="profilePicUpload3" accept=".png" />
                                                    <label for="profilePicUpload3"><i class="la la-pencil"></i></label>
                                                </div>
                                            </div>
