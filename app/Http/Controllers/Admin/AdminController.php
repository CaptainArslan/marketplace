...
class AdminController extends Controller
{
    ...
    public function getEmailLogo()
    {
        ...
        $image=getImage(imagePath()['emaillogo']['user']['path'] . '/' . $logo->email_logo, imagePath()['emaillogo']['user']['size']);
        return response()->json(['image' => $image]);
    }
    public function saveEmailLogo(Request $req)
    {
        $pImage = '';
        $file = $req->newemaillogo;
        $location = imagePath()['emaillogo']['user']['path'];
        $size = imagePath()['emaillogo']['user']['size'];
        $pImage = uploadImage($file, $location, $size);
        $logo = GeneralSetting::first()->update([
            'email_logo' => $pImage,
        ]);
        return response()->json(['succces' => "image is updated succesfully"]);
    }
}
