...
class SupportTicketController extends Controller
{
    public function tickets()
    {
        ...
        $items = SupportTicket::where('seller_id',0)->latest()->with('user')->paginate(getPaginate());

        return view('admin.support.tickets', get_defined_vars());
    }
    ...
    public function pendingTicket()
    {
        ...
        $empty_message = 'No Data found.';
        $items = SupportTicket::where('seller_id', 0)->whereIn('status', [0,2])->latest()->with('user')->paginate(getPaginate());
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::where('seller_id', 0)->whereIn('status', [3])->latest()->with('user')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'page_title','empty_message'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $empty_message = 'No Data found.';
        $items = SupportTicket::where('seller_id', 0)->latest()->with('user')->whereIN('status', [1])->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'page_title','empty_message'));
    }
